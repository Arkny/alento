...
export const PostCard = ({ post, onClick }: PostCardProps) => {
  return (
    <Card 
      className="bg-surface-elevated hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1 rounded-3xl border-0 overflow-hidden"
      onClick={onClick}
    >
      <div className="p-6">
