    ...
    <div className="relative">
      <div className="relative w-full">
        ...
        <Input
          ...
          className="pl-12 pr-16 py-3 bg-white/20 border-0 text-white placeholder:text-white/70 rounded-2xl h-12 text-base backdrop-blur-sm"
        />
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className="absolute right-2 top-1/2 transform -translate-y-1/2 h-8 w-8 hover:bg-white/10 text-white/70 hover:text-white rounded-lg"
            >
